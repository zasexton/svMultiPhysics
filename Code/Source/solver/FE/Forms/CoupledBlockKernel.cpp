...
void CoupledBlockKernel::maybeCompileMonolithic()
{
    ...
    // Monolithic JIT compilation will be implemented in Phase 2/3.
    // For now, we always fall back to per-block kernels.
    // The assembler's coupled path handles this gracefully.
