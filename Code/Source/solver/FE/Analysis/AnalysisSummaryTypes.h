...
struct StabilizationAdequacySummary {
    ...
    Real peclet_estimate{};
    Real peclet_regime_lower_bound{};
    Real peclet_regime_upper_bound{};
    Real cfl_estimate{};
    Real accepted_cfl_bound{};
    std::string peclet_scope;
    std::string cfl_scope;
    ...
    bool cfl_condition_satisfied{false};
    bool peclet_estimate_present{false};
    bool peclet_regime_bounds_present{false};
    bool cfl_estimate_present{false};
    bool accepted_cfl_bound_present{false};
