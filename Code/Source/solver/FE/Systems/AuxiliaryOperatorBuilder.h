#ifndef SVMP_FE_SYSTEMS_AUXILIARY_OPERATOR_BUILDER_H
#define SVMP_FE_SYSTEMS_AUXILIARY_OPERATOR_BUILDER_H
...
#endif // SVMP_FE_SYSTEMS_AUXILIARY_OPERATOR_BUILDER_H
