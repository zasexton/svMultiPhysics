#ifndef SVMP_FE_SYSTEMS_AUXILIARY_INITIALIZATION_SOLVER_H
#define SVMP_FE_SYSTEMS_AUXILIARY_INITIALIZATION_SOLVER_H
...
#endif // SVMP_FE_SYSTEMS_AUXILIARY_INITIALIZATION_SOLVER_H
